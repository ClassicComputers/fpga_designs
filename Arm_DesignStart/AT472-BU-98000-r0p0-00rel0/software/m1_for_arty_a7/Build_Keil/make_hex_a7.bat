...
call fromelf --vhx --32x1 --output bram_a7.hex objects\m1_for_arty_a7.axf
...
call fromelf --vhx --8x1  --output qspi_a7.hex objects\m1_for_arty_a7.axf
@REM - Files to load onto DAPLink QSPI board
call fromelf --bin        --output qspi_a7.bin objects\m1_for_arty_a7.axf

@REM - Copy the files to the relevant directories of the hardware project
copy bram_a7.* ..\..\..\hardware\m1_for_arty_a7\m1_for_arty_a7
copy qspi_a7.hex ..\..\..\hardware\m1_for_arty_a7\testbench
