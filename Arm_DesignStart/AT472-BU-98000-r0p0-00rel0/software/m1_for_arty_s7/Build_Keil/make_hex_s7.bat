...
call fromelf --vhx --32x1 --output bram_s7.hex objects\m1_for_arty_s7.axf
@REM - File to merge SW into bitstream
call fromelf --elf        --output bram_s7.elf objects\m1_for_arty_s7.axf
@REM - File to load into DAPLink QSPI simulation
call fromelf --vhx --8x1  --output qspi_s7.hex objects\m1_for_arty_s7.axf
@REM - Files to load onto DAPLink QSPI board
call fromelf --bin        --output qspi_s7.bin objects\m1_for_arty_s7.axf
